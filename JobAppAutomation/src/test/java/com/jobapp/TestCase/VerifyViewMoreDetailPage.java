...
public class VerifyViewMoreDetailPage {
	...
	@Test(description="Test case to view more details page working")
	public void verifyViewMoreDetailPageFunctionality() throws InterruptedException {
